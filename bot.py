...
async def cb_cards_open(cb: CallbackQuery):
    ...
    text = (
        ...
        "К состоянию, может быть, легче подойти не через вопрос, а через образ.\n\n"
...
async def cb_support_fast(cb: CallbackQuery):
    ...
    text = (
        ...
        "Давай просто поддержим физическое состояние.\n\n"
...
async def cb_anxiety_set(cb: CallbackQuery):
    ...
    if level >= 7:
        text = (
            ...
            "Давай начнём с того, что быстрее всего помогает физескому состоянию:\n"
